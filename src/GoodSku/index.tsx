...
export const YYGoodSku = (props: IGoodSkuProps) => {
  ...
  return (<View className='yy-skus-materiels' style={{
    margin
  }}>
  {(!!Object.keys(materielsGroup).length ||
    !!Object.keys(skusGroup).length) && (
                    ...
                    return (
                      <View
                        ...
                        className={`yy-skus-item yy-skus-item-color ${
                          [...(selectSkusGroup[v] || [])].includes(item.id)
                            ? 'shop-seleted'
                            : ''
                          }`}
                        onClick={() => {
                  ...
                  {materielsGroup[v].map((item, index) => {
                    ...
                    return (
                      <View
                        key={item.id}
                        className={`yy-skus-item yy-skus-item-color ${
                          [...(selectMaterielsGroup[v] || [])].includes(item.id)
                            ? 'shop-seleted'
                            : null
                          }`}
                        onClick={() => {
