...
export const YYGoodsGrid = (props: IProps & AtGridProps) => {
  ...
  return <View className="yy-goods-grid"
    style={inline ? {
      display: 'flex',
      flexDirection: 'row',
      backgroundColor
      ...
      {data.map((v, k) => {
        ...
        return (<View
          ...
          style={{
            ...
            width: inline ? `calc(${imageWidth} + 10px)` : `calc(${100 / columnNum}% - ${itemMargin} - ${itemMargin})`,
            float: 'left',
          ...
          <View
            ...
            {!!price && <View className="yy-goods-prices">
              <Text className='yy-goods-price'>¥{price}</Text>
              {!!originalPrice && (
                <Text className='yy-goods-original-price'>¥{originalPrice}</Text>
              )}
              <Text className='yy-goods-cart'>
                <Image src={cartImage} style={{
                  width: "16px",
                  height: '16px'
                }}/>
              </Text>
