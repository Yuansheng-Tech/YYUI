...
export const YYCoupon = (props: ICouponProps) =>{
  ...
  return (<View
    ...
    {data.map((v, k) => {
      ...
      return (<View key={k} className="yy-coupon-item" style={{
        color: color
      }}>
        <View className="yy-coupon-left" style={{
        ...
        <View className="yy-coupon-middle">
          ...
          <View className="yy-coupon-middle-center">
            ...
            <View className="yy-coupon-middle-b"
              style={{
                borderColor: borderColor
              }}></View>
            <View className="yy-coupon-middle-c"
              style={{
                borderColor: borderColor
              }}></View>
          </View>
        ...
        <View className="yy-coupon-right">
          ...
          <View
            className="yy-coupon-right-action"
