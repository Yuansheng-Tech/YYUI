...
export default function YYPopover(props: IPopoverProps) {
    ...
    <View onClick={handleClick}>
      ...
      <Popover ref="refPopover" state={state}>
        {list &&
          list.map((item) => {
            return (
              <View key={item.id} onClick={() => onClickItem(item)}>
                <PopoverItem hasline className="popover-item" class="popover-item" height={state.itemHeight}>
                  {item[label]}
                </PopoverItem>
              </View>
            );
